...
# NETWORK DIFFICULTY
sf=100000000
DifficultyLevel = 13912524048945.9/sf
NumberofNodes= 5
List=[6116052793760100000/sf,6116052793760100000/sf,18348158381280300000/sf,6116052793760100000/sf,85624739112641400000/sf]
length= len(List)
...
workbook = xlsxwriter.Workbook('POW 1st April 2020.xlsx')
